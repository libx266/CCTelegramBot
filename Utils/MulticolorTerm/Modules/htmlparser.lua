--source repository: https://github.com/msva/lua-htmlparser/tree/master

--[[

[GNU Lesser General Public License (LGPL)](http://www.gnu.org/licenses/lgpl-3.0.txt)

And, as an exception to the LGPL:

You are permitted to include a version of this library in your application,
without complying with section 4. d) 0) of LGPL 3.0
(requiring recipients of your application to be able to relink against
modified versions of the library).
...
-- }}}
-- Requires {{{
local ElementNode = require "Modules.htmlparser.ElementNode"
local voidelements = require "Modules.htmlparser.voidelements"
--}}}
local HtmlParser = {}
